...
settingsCategory.push(new SettingsCategoryItem("{{.settings.category.general}}", "ThreadfinAutoUpdate,tuner,epgSource,epgCategories,epgCategoriesColors,api,urlBasePath"));
